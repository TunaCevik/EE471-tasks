...
class OptimizedNeuralNetwork(nn.Module):
    def __init__(self, trial):
        ...
        out_channels_1 = trial.suggest_int("out_channels_1", 16, 64)
        out_channels_2 = trial.suggest_int("out_channels_2", 32, 128)
        ...
        # After two max pools of 2x2, 32x32 image becomes 8x8
        in_features = out_channels_2 * 8 * 8
        linear_units = trial.suggest_int("linear_units", 128, 512)
